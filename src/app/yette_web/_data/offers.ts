// Kiemelt ajánlatok adatai a Yette főoldalhoz.
...
export const OFFER_TABS: { id: OfferCategory; label: string; hint: string }[] = [
  ...
  { id: "tv", label: "Yette TV", hint: "Élő adás & felvétel" },
...
export const OFFERS: Record<OfferCategory, Offer[]> = {
  ...
  csomag: [
    ...
    },
    {
      ...
      price: 12480,
      unit: "Ft/hó",
      features: ["Yette L előfizetés", "Telefon 0 Ft előleggel", "24 havi részlet", "Bármikor bővíthető"],
      cta: "Összeállítom",
    },
  ],
};
...
export const DEVICES: Device[] = [
  { id: "iphone-15", name: "iPhone 15 128 GB", monthly: 9990, upfront: "0 Ft előleg", note: "Yette L mellé" },
