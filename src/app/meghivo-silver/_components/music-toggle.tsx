...
/**
 * SILVER extra: háttérzene a pár kedvenc dalával. Sosem indul magától –
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full border border-[var(--slv-line)] bg-[#1b2434]/90 px-4 py-2.5 text-sm text-[var(--slv-silver)] backdrop-blur transition-colors hover:bg-[#222d40]"
      >
