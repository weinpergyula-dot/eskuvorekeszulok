...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    // Szélesebb (3/4-es) kivágat: a keret aljára ül, nagyobbra véve és jobbra
    // tolva – a jobb szélen szándékosan kilóg a képernyőről.
    imgClass: "absolute bottom-0 -right-10 block w-[122%] max-w-none",
    ...
    <div className="relative">
      ...
      >
        <div className="pb-0 md:pb-10">
          ...
          <div className="absolute bottom-12 left-4 z-10 w-[52%] max-w-[188px] rounded-[18px] border border-white/60 bg-white/25 p-3 shadow-[0_18px_50px_rgba(0,35,64,0.18)] backdrop-blur-[3px] sm:left-6 md:static md:mt-6 md:w-full md:max-w-[320px] md:rounded-[20px] md:border-white/70 md:bg-white/60 md:p-4 md:backdrop-blur-xl">
