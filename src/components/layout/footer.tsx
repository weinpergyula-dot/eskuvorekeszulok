        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <span className="inline-flex items-center justify-center w-8 h-8 rounded-sm bg-[#2a9d8f] text-white font-bold text-xs">
                EK
              </span>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-800 mb-3">Szolgáltatások</h3>
            <ul className="space-y-2">
              {[
                ...
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="text-sm text-gray-500 hover:text-[#2a9d8f] transition-colors"
                  >
                    {item.label}
                  </Link>
                </li>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-800 mb-3">Hasznos linkek</h3>
            <ul className="space-y-2">
              {[
