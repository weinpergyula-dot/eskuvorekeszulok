...
export function ProviderCard({ provider, showStatus = false }: ProviderCardProps) {
  ...
  return (
    <a
      ...
      className="bg-gray-50 rounded-xl border border-gray-200 shadow-sm hover:border-[#2a9d8f] hover:shadow-md transition-all flex flex-col overflow-hidden cursor-pointer group"
    >
      {/* Header with avatar */}
